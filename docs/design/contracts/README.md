...
7. `observation-batch.schema.json` 固定一次 Adapter 调用的来源、查询、Resource、质量和 Artifact 引用；`evidence-bundle.schema.json` 固定 Observation 到 Evidence 的可追溯关系，具体规则以[第 27 章](../opspilot-system-design/16-distributed-target-and-observability-adapters.md)为准。
